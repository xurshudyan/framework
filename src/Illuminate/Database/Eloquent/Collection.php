...
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     *
     * @param  array<array-key, array| $relations (callable(\Illuminate\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     * @param  array<array-key, array| $relations (callable(\Illuminate\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|string>  $relations
     * @return $this
     */
